...
Models backed by **Transformers** (not vLLM): `fastvlm_0b5`, `fastvlm`, `fastvlm_7b`, `smolvlm2`, `florence2`, `lfm25_vl`, `phi4_vision`, `cosmos_reason2_2b`, `cosmos_reason2_8b`, `glm46v_flash`, `minicpm_v45` — these use `TransformersVLMModel` instead of `VLMModel`.
